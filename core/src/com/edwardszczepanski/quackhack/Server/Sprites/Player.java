...
public class Player extends Sprite{
    ...
    public void defineLights(){
        pointLight = new PointLight(PlayScreen.rayHandler, 150, new Color((float)(Math.random()), (float)(Math.random()), (float)(Math.random()), (float)(Math.random())), 3f * 1.2f*64/ QuackHack.PPM,0,0);
